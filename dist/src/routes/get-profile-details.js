...
router.get("/api/profile", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (profile) {
        finalresult = new base_profile_details_1.ProfileDetails(profile.get("_id"), profile.get("fullname"), profile.get("emailid"), profile.get("facebookURL"), profile.get("twitterURL"), profile.get("instagramURL"), profile.get("linkedinURL"), profile.get("profilePic")).parseDetails();
    }
